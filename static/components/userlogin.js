const userlogin={
    ...
    <div id="app" style="text-align: center; padding: 20px; background-color: #fff; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        <h1 style="color: #333;">Client User login</h1>
        <form @submit.prevent="" style="margin-top: 20px;">
            ...
            <label for="password" v-model="formData.password" style="display: block; margin-bottom: 5px; color: #555;">Password:</label>
            <input type="password" id="password" v-model="password" required style="width: 40%; padding: 8px; margin-bottom: 10px; box-sizing: border-box;">
             <br>
